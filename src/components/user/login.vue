<template>
    <div>
      ...
      <header id="responsive-header" class="responsive-top">
        <div class="logo">
          <a href="/">
            <img src="/static/image/logo.png" width="100" height="25" class="visual" alt="Sketchfab">
          </a>
        </div>
      </header>
            ...
            <div class="popup-content">
              ...
              <div class="social">
                <div class="form-field form-buttons">
                  ...
                  <a class="form-button btn-large btn-secondary" data-action="signup-twitter"><i class="fa fa-twitter"></i> Twitter</a>
                </div>
              </div>
